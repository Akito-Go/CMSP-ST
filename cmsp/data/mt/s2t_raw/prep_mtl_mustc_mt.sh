...
export SRC_LANG=en
export TGT_LANG=de
export SPM_MODEL=/path/to/cmsp/data/st/s2t_raw/spminfo/mustc/en-de/spm_unigram10000_st.model
export SPM_DICT=/path/to/cmsp/data/st/s2t_raw/spminfo/mustc/en-de/spm_unigram10000_st.txt

export TEXT_PATH_TRAIN=/path/to/cmsp/data/st/dataset/MuST-C/en-de/data/train/txt
export TEXT_PATH_DEV=/path/to/cmsp/data/st/dataset/MuST-C/en-de/data/dev/txt

export DATA=mustc
export PAIR=${SRC_LANG}-${TGT_LANG}
export TEXT_SPM=/path/to/cmsp/data/mt/s2t_raw/spminfo/${DATA}/${PAIR}
export PREP=/path/to/cmsp/data/mt/s2t_raw
