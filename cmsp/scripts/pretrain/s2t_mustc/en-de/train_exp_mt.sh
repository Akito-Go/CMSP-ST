...
export MT_ROOT=/path/to/cmsp/data/mt/s2t_raw/spminfo/mustc/en-de/exp_mt
export SAVE_DIR=/path/tocmsp/scripts/saveckp/${MODE}/${TYPE}/${TASK}/${BRAN}
...
fairseq-train ${MT_ROOT} \
	...
	--max-tokens 16384 --max-update 250000 --num-workers 4 \
